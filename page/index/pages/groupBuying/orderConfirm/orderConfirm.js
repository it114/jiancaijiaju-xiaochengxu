    ...
    wx.getStorage({
      ...
      success: function (res) {
        that.setData({
          ...
          num:num,
          totalPrice: util_js.toFixed(num*price,2),
          token: res.data.data.token,
          valueName: valueName,
          payFee: util_js.toFixed(num * price, 2),
        })
      }
    })
    wx.getStorage({
  ...
  payMoney:function(){
    ...
    wx.getStorage({
      ...
      success: function (res) {
        ...
        wx.request({
          url: config.buyGoodUrl,
          data: { token: res.data.data.token, id: that.data.id, gid: that.data.gid, num: that.data.num, addressId: that.data.addressId, attrName: that.data.valueName, couponId: that.data.voucherId, vid: that.data.vid},
          method: 'GET',
          success: function (res) {
